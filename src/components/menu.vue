    ...
    <ul class="navbar-nav h-100" id="navbar-nav">
      ...
      <li class="nav-item">
        <router-link class="nav-link menu-link" to="/">
          ...
          <span data-key="t-dasbhoard"> Dashboard</span>
        </router-link>
      </li>

      <li class="nav-item">
        <router-link class="nav-link menu-link" to="/agencia">
          <i class="ri-building-4-line"></i>
          <span data-key="t-agencia"> Agência</span>
        </router-link>
      </li>

      <li class="nav-item">
        <router-link class="nav-link menu-link" to="/veiculo">
          <i class="ri-at-line"></i>
          <span data-key="t-veiculo"> Veículo</span>
        </router-link>
      </li>

      <li class="nav-item">
        <router-link class="nav-link menu-link" to="/campanha">
          <i class="ri-image-add-line"></i>
          <span data-key="t-campanha"> Campanha</span>
        </router-link>
      </li>
      <!-- end Dashboard Menu -->
    </ul>
