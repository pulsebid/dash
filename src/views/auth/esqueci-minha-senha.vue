        ...
        <b-row class="justify-content-center">
          <b-col md="8" lg="6" xl="5">
            <b-card no-body class="mt-4">
              <b-card-body class="p-4">
                <div class="text-center mt-2">
                  ...
                  <p class="text-muted">Redefinir senha com a Ad Pulse</p>
            ...
            <div class="mt-4 text-center">
              <p class="mb-0">
                Espere, Eu lembo da minha senha...
                <router-link to="/entrar" class="fw-semibold text-primary text-decoration-underline">
                  Clique aqui
                </router-link>
              </p>
            </div>
          ...
          <b-col lg="12">
            <div class="text-center">
              <p class="mb-0 text-muted">
                &copy; {{ new Date().getFullYear() }} Ad Pulse. Feito com
