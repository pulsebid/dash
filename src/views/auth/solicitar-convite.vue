      ...
      <b-container>
        ...
        <b-row class="justify-content-center">
          <b-col md="8" lg="6" xl="5">
            <b-card no-body class="mt-4">
              ...
              <b-card-body class="p-4">
                <div class="text-center mt-2">
                  ...
                  <p class="text-muted">Get your free Ad Pulse account now</p>
                </div>
                <div class="p-2 mt-4">
                  <form class="needs-validation" @submit.prevent="tryToRegisterIn">
                    ...
                    <div class="mb-4">
                      <p class="mb-0 fs-12 text-muted fst-italic">By registering you agree to the Ad Pulse <b-link
            ...
            <div class="mt-4 text-center">
              <p class="mb-0">Já possui uma conta ? <router-link to="/entrar"
                  class="fw-semibold text-primary text-decoration-underline"> Entrar </router-link>
              </p>
            </div>
          </b-col>
        </b-row>
        ...
        <b-row>
          <b-col lg="12">
            <div class="text-center">
              <p class="mb-0 text-muted">&copy; {{ new Date().getFullYear() }} Ad Pulse. Feito com <i
